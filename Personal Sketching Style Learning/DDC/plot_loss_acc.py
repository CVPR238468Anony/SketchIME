...
def plot_loss_acc(source, target, no_epochs):
    ...
    pkldir = os.path.join("logs", source + "_to_" + target,str(no_epochs) + "_epochs_128_s_128_t_batch_size")
    ...
    path_adapt_log = [pkldir + "/adaptation_training_statistic.pkl",pkldir + "/adaptation_testing_s_statistic.pkl",pkldir + "/adaptation_testing_t_statistic.pkl"]

    path_no_adapt_log = [pkldir + "/no_adaptation_training_statistic.pkl",pkldir + "/no_adaptation_testing_s_statistic.pkl",pkldir + "/no_adaptation_testing_t_statistic.pkl"]
...
def main():
    ...
    #plot_loss_acc(amazon,webcam,100)
