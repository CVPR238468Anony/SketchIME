...
class BaseOptions:
    ...
    def initialize(self):
        # data params
        self.parser.add_argument('--class-name', type=str, default="SketchIME-SRS",
                                 help='the name of the class to train or test')
        self.parser.add_argument('--points-num', type=int, default=200, 
                                 help='the number of the points in one sketch')
        self.parser.add_argument('--dataset', type=str, default="SRS200",
        ...
        self.parser.add_argument('--out-segment', type=int, default=95, 
                                 help='the number of the labels of the segment')
        self.parser.add_argument('--batch-size', type=int, default=256, 
        ...
        # other
        self.parser.add_argument('--num-workers', type=int, default=12,
                                 help='')
...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument("--valid-dataset", type=str, default='valid',
        ...
        self.parser.add_argument('--run-test-freq', type=int, default=5, 
