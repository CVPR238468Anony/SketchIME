...
def set_up_datasets(args):
    ...
    if args.dataset == 'sketch':
        import lib.dataloader.FSCIL.sketch.sketch as Dataset
        args.base_class = 118
...
def get_base_dataloader(args):
    ...
    if args.dataset == 'sketch':
        train_txt_path = "data/index_list/" + args.dataset + "/session_0.txt"
        test_txt_path = "data/index_list/" + args.dataset + "/test_0.txt"
        trainset = args.Dataset.SketchPngDataset(root=args.data_folder, list_txt_url=train_txt_path)
        testset = args.Dataset.SketchPngDataset(root=args.data_folder, list_txt_url=test_txt_path)
