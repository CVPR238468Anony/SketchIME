...
def main():
    ...
    optimizer = torch.optim.SGD([
        ...
        #{"params": model.bottleneck.parameters(), "lr":10*LEARNING_RATE},
    ...
    for epoch in tnrange(0, args.epochs):
        ...
        torch.save(model.state_dict(), "logs/CDAN/pretrain/"+str(epoch+1)+"ResNet18.pth")
    # save log results
    print("saving training without adaptation...")
    save_log(training_statistic, 'CDAN/result12/pretrain/no_adaptation_training_statistic.pkl')
    save_model(model, 'CDAN/result12/pretrain/no_adaptation_checkpoint.tar')
